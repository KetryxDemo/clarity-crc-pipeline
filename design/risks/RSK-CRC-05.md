...
**This risk is knowingly accepted in exchange for a reduction in RSK-CRC-01, and the exchange
is the central design trade-off of the assay.**
...
programme most needs to reach. Specificity is therefore not merely characterised at
validation (RC-3) but is the quantity that bounds the acceptability of this whole trade-off.
