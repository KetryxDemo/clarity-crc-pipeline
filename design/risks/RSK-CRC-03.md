...
on a negative report (RC-3 of RSK-CRC-01) tells a clinician that a negative result does not
rule out cancer, which is true and useful. It does not tell them that this particular
negative result was produced at a sensitivity below the one printed on the report.
